...
import colorEditor from './componenets/color-editor';
import colorPicker from './componenets/color-picker';
import elementEditor from './componenets/element-editor';
...
Vue.component('color-editor', colorEditor);
Vue.component('color-picker', colorPicker);
Vue.component('element-editor', elementEditor);
